...
This skill is the gald3r answer to Hermes v0.12's "Curator release". It is designed
...
The ranked list is the headline output for AC10 — it is what `hermes curator status`
returns; gald3r returns the same shape.
...
- Hermes v0.12 "Curator release" — competitive reference (see `competitive_intelligence_20260507.md`)
