...
| `tasks/completed/` | `failed`, `cancelled`, `paused`, `resource-gated` (closed/ folder removed — all terminal states go to completed/) |
...
2. **List all task files recursively** (T1025 status subfolders):
   ...
   ```
   This covers `tasks/open/`, `tasks/in-progress/`, `tasks/awaiting-verification/`, `tasks/completed/**`
