...
description: Multi-agent QA gates for animation/video—specs, narrative, render readiness, asset handoff checks.
...
- Verification rule (32_GALD3R_verification.md) already enforces implementer ≠ verifier
