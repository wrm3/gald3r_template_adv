...
description: Cloudflare Workers & Pages — scaffolding, deployment, KV/D1/R2/Durable Objects storage, debug, secrets. Depends on skl-cloudflare-dns for zone setup.
---
...
# Enter: app.example.com → Cloudflare will create a CNAME record automatically
