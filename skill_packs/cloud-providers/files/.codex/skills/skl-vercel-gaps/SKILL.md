...
description: Vercel integration gaps for gald3r projects — covers areas the Cursor Vercel plugin doesn't handle. gald3r install on Vercel projects, MCP server deployment, secrets management, monorepo support.
---
...
> **This skill only covers the gald3r-specific gaps** that the Vercel plugin does not handle — see the coverage map below.
...
|------|--------------|-----------|
| Deploy Next.js/React | ✅ | — |
| Environment variables (UI) | ✅ | — |
| Preview deployments | ✅ | — |
| gald3r install on Vercel project | ❌ | ✅ |
| MCP server URL wiring | ❌ | ✅ |
| Secret injection for gald3r services | ❌ | ✅ |
| Monorepo config (nx/turborepo) | Partial | ✅ |
| Edge function debugging | Partial | ✅ |
| Deploy hooks (build triggers) | ❌ | ✅ |
...
# OR manual: copy gald3r_template_full/.gald3r/ to your project
...
- Rotate secrets via `vercel env rm` → `vercel env add`
