...
description: AWS networking — VPC architecture, Route 53 DNS, CloudFront CDN, ALB/NLB load balancers, VPN, VPC peering. 3-tier VPC template included.
---
...
|------|------|------|--------|
| Public | 10.0.1.0/24 | 10.0.2.0/24 | IGW → internet |
| Private | 10.0.10.0/24 | 10.0.11.0/24 | NAT → internet |
...
**OAC — Origin Access Control (replaces OAI for S3 origins):**
```bash
