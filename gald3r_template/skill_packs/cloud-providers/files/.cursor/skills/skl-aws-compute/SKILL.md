...
description: AWS compute and deployment — EC2, Lambda, ECS, App Runner, CLI essentials, CDK patterns. Requires skl-aws-iam for permission setup.
---
...
Fully managed container service — simplest path from Docker image to URL.
