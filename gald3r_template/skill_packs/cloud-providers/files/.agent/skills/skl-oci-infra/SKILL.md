---
name: skl-oci-infra
description: Oracle Cloud Infrastructure — compute, VCN networking, OKE Kubernetes, Object Storage, OCI CLI. gald3r production cloud target.
---
...
|-------|------|-------|---------|
| VM.Standard.A1.Flex | ARM (Free) | 1–4 | gald3r Docker, dev servers |
| VM.Standard.E4.Flex | AMD | 1–64 | General workloads |
...
**Pre-Authenticated Requests (PAR — temporary anonymous access URLs):**
```bash
...
## DOCKER-ON-OCI — gald3r Stack Deployment
