...
description: Google Vertex AI & Gemini Cloud — Gemini API, Vertex AI Model Garden, Cloud Run deployment, GCP setup, grounding with Google Search, cost management.
---
...
**Vertex AI Search — RAG Engine (document grounding):**
```python
...
# result.document.text — extracted full text
# result.document.entities — structured fields (for form parsers)
```
