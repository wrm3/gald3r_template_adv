---
name: skl-aws-iam
description: AWS IAM & security reference — users, roles, policies, STS, Secrets Manager, audit. 5 copy-paste least-privilege policy templates. Foundation for all AWS skills.
---
# AWS IAM & Security
