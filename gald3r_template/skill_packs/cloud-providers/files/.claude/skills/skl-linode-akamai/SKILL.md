...
description: Linode/Akamai Cloud — VPS (Linodes), LKE Kubernetes, Object Storage, managed databases, private networking, Docker deployment.
---
...
# CSI driver — provision Linode Block Storage volumes:
kubectl apply -f - <<'EOF'
apiVersion: v1
...
# No explicit creation step needed — first use creates the VLAN
```
...
# 1. Edit /etc/ufw/after.rules — add BEFORE the COMMIT line:
# *filter
# :DOCKER-USER - [0:0]
