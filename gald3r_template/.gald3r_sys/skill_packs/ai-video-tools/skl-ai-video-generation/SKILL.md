...
description: "Generate AI videos with 40+ models ΓÇö text-to-video, image-to-video, lipsync, avatar, upscaling, foley. Covers Veo, Wan, Seedance, Grok, OmniHuman, and more via inference.sh CLI."
