---
name: remotion-video
description: Remotion React videoΓÇöcompositions, audio, captions, 3D, transitions, cloud render from code.
tags: [video, react, remotion, animation, rendering, production]
skill_group: "ai-video-tools"
skill_category: "AI Video Production"
---

# Remotion ΓÇö Programmatic Video in React

Create videos programmatically using React components. Remotion treats video as a function of time ΓÇö every frame is a React component render.
...
```
Frame (number) ΓåÆ React Component ΓåÆ Image ΓåÆ Video
```
