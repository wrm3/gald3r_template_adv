...
description: Startup product strategyΓÇöMVP, roadmaps, stack choice, QA, build vs buy, PMF across industries.
...
**Framework**: Vision ΓåÆ Strategy ΓåÆ Roadmap ΓåÆ Backlog
...
- **RICE**: Reach ├ù Impact ├ù Confidence ├╖ Effort
...
5. **Deployment**: Staging ΓåÆ Production
...
2. **product_roadmap_planning.md** (~450 lines)
   - Vision ΓåÆ Strategy ΓåÆ Roadmap ΓåÆ Backlog
