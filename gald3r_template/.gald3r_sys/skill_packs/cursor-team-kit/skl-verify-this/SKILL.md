---
skill_group: workflow:dev
skill_category: cursor-team-kit
---
# Verify This
...
- CLI/TUI behavior: `cli-control`, terminal transcript, or demo recording.
- UI behavior: `ui-control`, screenshots, accessibility snapshots, or browser traces.
