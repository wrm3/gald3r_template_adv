...
Authoritative reference for Roo Code (VS Code extension) customization in gald3r projects. Covers .roorules, mode-specific rules, memory bank, and gald3r install verification.

## When to use

- Invoke via `@g-skl-platform-roo` (or when the agent determines this skill is relevant)
