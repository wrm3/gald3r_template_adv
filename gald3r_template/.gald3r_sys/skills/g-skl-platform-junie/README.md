...
Authoritative reference for JetBrains Junie (AI coding plugin) customization in gald3r projects. Covers .junie/guidelines.md, custom instructions, and gald3r install verification.

## When to use

- Invoke via `@g-skl-platform-junie` (or when the agent determines this skill is relevant)
