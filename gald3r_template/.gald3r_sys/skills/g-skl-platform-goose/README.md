...
Authoritative reference for Goose (Block) AI agent customization in gald3r projects. Covers .goose/ config, instructions files, extensions, and gald3r install verification.

## When to use

- Invoke via `@g-skl-platform-goose` (or when the agent determines this skill is relevant)
