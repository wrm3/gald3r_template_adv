...
Authoritative reference for Mistral Vibe coding agent customization in gald3r projects. Covers .mistral/ config, agent instructions, and gald3r install verification.

## When to use

- Invoke via `@g-skl-platform-mistral` (or when the agent determines this skill is relevant)
