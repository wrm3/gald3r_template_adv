...
> **Local-only:** This skill lives in root IDE folders for maintainers of the gald3r ecosystem. It is intentionally **not** copied into `gald3r_template_full/`, `gald3r_template_slim/`, or `gald3r_template_adv/`. The `star_wars_personality` rule is the always-on voice layer; this skill is the depth layer.
