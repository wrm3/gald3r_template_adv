<#
.SYNOPSIS
    Install the personality-rules pack into a project.
...
Write-Host ""
Write-Host "personality-rules pack" -ForegroundColor Cyan
...
if ($List) {
    ...
    Write-Host "Installed $copied file(s). Restart your IDE to load new rules." -ForegroundColor Green
}
